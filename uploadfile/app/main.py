...
from app.agent_demo.personal_chief import close_agent, init_agent
...
frontend_dist_dir = os.path.join(os.path.dirname(app_dir), "frontend", "dist")
legacy_static_dir = os.path.join(app_dir, "static")

# 优先使用可维护前端的 Vite 构建；尚未构建时保留原静态导出作为回退。
static_dir = (
    frontend_dist_dir
